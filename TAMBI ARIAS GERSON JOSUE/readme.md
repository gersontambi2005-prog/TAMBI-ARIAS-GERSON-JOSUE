...
*(Nota para el evaluador: Las capturas de pantalla reales del funcionamiento del sitio se adjuntarán una vez desplegado el repositorio).*

*   **Vista Principal y Catálogo**: [Espacio reservado para captura de pantalla]
*   **Funcionalidad del Matchmaker y Modo Nocturno**: [Espacio reservado para captura de pantalla]
